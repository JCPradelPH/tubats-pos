export class PageConfig {
	public defaults: any = {
		...
		inventory: {
			page: {
				'title': 'Inventory',
				'desc': 'Manage item stocks and details'
			},
		},
		'menu-category': {
			page: {
				'title': 'Menu Category',
				'desc': 'Create categories to easily organize your menu'
			},
		},
		'item-menu': {
			page: {
				'title': 'Item Menu',
				'desc': 'Create menu items based on your inventory'
			},
		},
		pos: {
			page: {
		...
		'recurring-expense': {
			page: {
				...
				'desc': 'Bills, Employee Salaries, Allowances, etc.'
			},
		},
		'expense-and-utility': {
			page: {
				'title': 'Expense and Utility',
				'desc': 'Track the amount of expenses of your business'
			},
		},
		'pos-transactions': {
			page: {
